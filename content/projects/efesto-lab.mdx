export const metadata = {
  ...
  heroImage: "/career/efesto-lab/logo.png",
  featuredImage: "/career/efesto-lab/logo.png",
  headerImage: "/career/efesto-lab/header.png",
  skills: [
    "Maya",
    "Ftrack",
    "FFMpeg",
...
![Ronin](/career/efesto-lab/ronin.png)
...
![Proxy Location](/career/efesto-lab/proxy-location.png)
...
![Animation Manager](/career/efesto-lab/animation-manager.png)
...
<MacBookShowcase
  ...
  images={[
    "/career/efesto-lab/submit-maya.png",
    "/career/efesto-lab/submit-slate.png",
    "/career/efesto-lab/submit-timecode.png",
  ]}
/>
...
![Image Publisher](/career/efesto-lab/image-publisher.png)
...
<Gallery
  ...
  images={[
    "/career/efesto-lab/docs-builder-list.png",
    "/career/efesto-lab/docs-builder-detail.png",
  ]}
/>
...
<MacBookShowcase
  className="max-sm:mt-4"
  screenClassName="bg-black"
  images={["/career/efesto-lab/4-review.png"]}
/>
