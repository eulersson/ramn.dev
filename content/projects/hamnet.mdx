export const metadata = {
  ...
  heroImage: "/work/hamnet/shout.webp",
...
<Gallery
  ...
  images={[
    "/work/hamnet/screen.webp",
    "/work/hamnet/setup.webp",
    "/work/hamnet/technician.webp",
  ]}
/>
...
counterpart. That involved **time-warping**. Just as time slowed down for a while
and then synched up.

I felt very valued because <Hi>I could accomodate the low budget for matching
